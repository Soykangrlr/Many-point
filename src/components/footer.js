...
<footer className="p-4 bg-white sm:p-6 dark:bg-gray-900">
    <div className="md:flex md:justify-between">
            ...
            <BsFillHandbagFill size="2em" className="text-blue-500"/>
                 <h1 className=" text-lg font-bold tracking-widest">Markets</h1>
            </div>
  
        <div className="grid grid-cols-2 gap-8  md:grid-cols-2 lg:grid-cols-4">
            <div>
                <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Useful Link</h2>
            ...
            <div  className="flex mt-4 space-x-6  sm:mt-0"> <a href="#" className="text-blue-500">
